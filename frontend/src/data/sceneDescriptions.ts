...
In this scene, we want to teach the student about centripetal force, so the view should be from the rear of the car, showing a fricitonal force that allows the car to turn.
...
const blockScene = `A square block is resting on an INCLINED 30 degree surface with a coefficient of friction of 0.2. The block has a mass of 3 kg.
